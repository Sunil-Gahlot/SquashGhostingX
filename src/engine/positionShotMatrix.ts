...
export const POSITION_SHOT_MATRIX: Record<Position, ShotEntry[]> = {
  FR: [
    { name: 'Forehand Drive',         voiceText: 'forehand drive',        weight: 'primary',   groups: ['drives', 'rails', 'mixed'] },
    { name: 'Forehand Cross Court',    voiceText: 'forehand cross court',  weight: 'secondary', groups: ['drives', 'cross', 'diagonals', 'mixed'] },
    { name: 'Forehand Drop',           voiceText: 'forehand drop',         weight: 'primary',   groups: ['drops',  'front-court', 'mixed'] },
    { name: 'Forehand Boast',          voiceText: 'forehand boast',        weight: 'secondary', groups: ['boasts', 'diagonals', 'mixed'] },
    { name: 'Forehand Volley',         voiceText: 'forehand volley',       weight: 'secondary', groups: ['volleys', 'front-court', 'mixed'] },
    { name: 'Forehand Lob',            voiceText: 'forehand lob',          weight: 'advanced',  groups: ['lobs',   'mixed'] },
    { name: 'Kill Shot',               voiceText: 'kill shot',             weight: 'advanced',  groups: ['kills',  'front-court', 'mixed'] },
  ],
  FL: [
    { name: 'Backhand Drive',          voiceText: 'backhand drive',        weight: 'primary',   groups: ['drives', 'rails', 'mixed'] },
    { name: 'Backhand Cross Court',    voiceText: 'backhand cross court',  weight: 'secondary', groups: ['drives', 'cross', 'diagonals', 'mixed'] },
    { name: 'Backhand Drop',           voiceText: 'backhand drop',         weight: 'primary',   groups: ['drops',  'front-court', 'mixed'] },
    { name: 'Backhand Boast',          voiceText: 'backhand boast',        weight: 'secondary', groups: ['boasts', 'diagonals', 'mixed'] },
    { name: 'Backhand Volley',         voiceText: 'backhand volley',       weight: 'secondary', groups: ['volleys', 'front-court', 'mixed'] },
  ...
  MR: [
    ...
    { name: 'Forehand Boast',          voiceText: 'forehand boast',        weight: 'advanced',  groups: ['boasts', 'diagonals', 'mixed'] },
  ],
  ML: [
    { name: 'Backhand Drive',          voiceText: 'backhand drive',        weight: 'primary',   groups: ['drives', 'rails', 'mixed'] },
    ...
    { name: 'Backhand Boast',          voiceText: 'backhand boast',        weight: 'advanced',  groups: ['boasts', 'diagonals', 'mixed'] },
  ],
  BR: [
    { name: 'Forehand Drive (Length)', voiceText: 'forehand drive',        weight: 'primary',   groups: ['drives', 'rails', 'mixed'] },
    { name: 'Forehand Cross Court',    voiceText: 'forehand cross court',  weight: 'secondary', groups: ['drives', 'cross', 'diagonals', 'mixed'] },
  ...
  BL: [
    { name: 'Backhand Drive (Length)', voiceText: 'backhand drive',        weight: 'primary',   groups: ['drives', 'rails', 'mixed'] },
    { name: 'Backhand Cross Court',    voiceText: 'backhand cross court',  weight: 'secondary', groups: ['drives', 'cross', 'diagonals', 'mixed'] },
  ...
  FMCR: [
    { name: 'Forehand Volley',         voiceText: 'forehand volley',       weight: 'primary',   groups: ['volleys', 'mixed'] },
    { name: 'Forehand Drive',          voiceText: 'forehand drive',        weight: 'secondary', groups: ['drives', 'rails', 'mixed'] },
    { name: 'Forehand Drop',           voiceText: 'forehand drop',         weight: 'secondary', groups: ['drops',  'front-court', 'mixed'] },
    { name: 'Kill Shot',               voiceText: 'kill shot',             weight: 'advanced',  groups: ['kills',  'front-court', 'mixed'] },
    { name: 'Forehand Lob',            voiceText: 'forehand lob',          weight: 'advanced',  groups: ['lobs',   'mixed'] },
  ],
  FMCL: [
    { name: 'Backhand Volley',         voiceText: 'backhand volley',       weight: 'primary',   groups: ['volleys', 'mixed'] },
    { name: 'Backhand Drive',          voiceText: 'backhand drive',        weight: 'secondary', groups: ['drives', 'rails', 'mixed'] },
    { name: 'Backhand Drop',           voiceText: 'backhand drop',         weight: 'secondary', groups: ['drops',  'front-court', 'mixed'] },
    { name: 'Kill Shot',               voiceText: 'kill shot',             weight: 'advanced',  groups: ['kills',  'front-court', 'mixed'] },
    { name: 'Backhand Lob',            voiceText: 'backhand lob',          weight: 'advanced',  groups: ['lobs',   'mixed'] },
  ],
  BMCR: [
